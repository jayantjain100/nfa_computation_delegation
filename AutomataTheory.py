# General codebase for conversions:  regex -> NFA -> DFA -> minimised DFA
# Code borrowed from: https://github.com/sdht0/automata-from-regex/blob/ce4665e51b436210fc388c9919346f0453a9fb4c/cli.py
...
class DFAfromNFA:
    ...
    def buildDFA(self, nfa):
        ...
        for value, state in list(allstates.items()):
